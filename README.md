...
Pipeline Overview
The project follows a clean, end‑to‑end pipeline from raw data to an interactive fake‑news detector powered by a BiLSTM + scikit‑learn hybrid model.
...
TF‑IDF vectors for the scikit‑learn classifier.
This ensures both deep and classical models can operate on the same high‑quality input.
